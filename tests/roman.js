...
QUnit.module('Тестируем функцию roman', function () {
	...
	QUnit.test('roman правильно определяет инвалидные входные параметры', function (assert) {
		...
		assert.strictEqual(roman('X123'), null);
		assert.strictEqual(roman('321X'), null);
